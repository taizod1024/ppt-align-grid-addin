                                ...
                                If strUrl <> pptActionSetting.Hyperlink.Address Then
                                    ...
                                    If Not IsExistUrl(strUrl) Then
                                        ...
                                        For j = i To pptShape.TextFrame.TextRange.Characters.Count
                                            Dim pptActionSettingLabel As ActionSetting
                                            Set pptActionSettingLabel = pptShape.TextFrame.TextRange.Characters(j).ActionSettings(pptMouseActivation)
                                            If pptActionSettingLabel.Action <> ppActionHyperlink Then Exit For
                                            If strUrl <> pptActionSettingLabel.Hyperlink.Address Then Exit For
                                        ...
                                        pptShape.TextFrame.TextRange.Characters(i, Len(strLabel)).Select
                                        DoEvents
